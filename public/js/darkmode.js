...
togglebtn.addEventListener("click", e => {
    ...
    var darkmode = document.getElementById("darkmode-btn")
    ...
    darkmode.children[0].children[0].style.transform = "rotate(360deg)"
    darkmode.children[0].children[0].style.fill = style.color
    darkmode.children[0].children[0].children[1].outerHTML = style.path
